...
- [Rendering UI with React](#rendering-ui-with-react)
  ...
  - [Components in JSX](#components-in-jsx)
    - [Traditional v Arrow Function Syntax](#traditional-v-arrow-function-syntax)
...
- [State Management](#state-management)
  - [Props](#props-1)
  - [State](#state)
  - [How to Change State](#how-to-change-state)
  - [PropTypes](#proptypes)
...
- [Hooks](#hooks)
  ...
  - [Removing Data from the Database](#removing-data-from-the-database)
  - [Side Effect Cleanup](#side-effect-cleanup)
  - [Additional Hooks](#additional-hooks)
- [Routing](#routing)
  - [Single Page Applications](#single-page-applications)
  - [React Router](#react-router)
  - [Dynamically Rendering Pages](#dynamically-rendering-pages)
